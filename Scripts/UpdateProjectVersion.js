...
const VersionManager = require("./Shared/VersionManager");
const RepositoryManager = require("./Shared/RepositoryManager");
const ChangelogManager = require("./Shared/ChangelogManager");
